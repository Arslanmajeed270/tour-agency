                ...
                <div className="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
                            ...
                            <div className="row">
                                    ...
                                    <div className="kt-widget17">
                                      ...
                                      <div className="kt-widget17__stats">
                                        <div className="kt-widget17__items">
                                          <div className="kt-widget17__item">
                                            <span className="kt-widget17__icon">
                                              <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--brand">
                                          ...
                                          <div className="kt-widget17__item">
                                            <span className="kt-widget17__icon">
                                              <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--success">
                                                <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                        ...
                                        <div className="kt-widget17__items">
                                          <div className="kt-widget17__item">
                                            <span className="kt-widget17__icon">
                                              <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--warning">
                                                <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                                  <rect id="bound" x={0} y={0} width={24} height={24} />
                                          ...
                                          <div className="kt-widget17__item">
                                            <span className="kt-widget17__icon">
                                              <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--danger">
                                                <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                                  <rect id="bound" x={0} y={0} width={24} height={24} />
                              ...
                              <div className="col-xl-4">
                                ...
                                <div className="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half">
                                  <div className="kt-portlet__head kt-portlet__space-x">
                                    ...
                                    <div className="kt-portlet__head-toolbar">
                                      <Link to='#' className="btn btn-label-success btn-sm btn-bold dropdown-toggle" data-toggle="dropdown">
                                      Export
                                      </Link>
                                      <div className="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                                        <ul className="kt-nav">
                                  ...
                                  <div className="kt-portlet__body kt-portlet__body--fluid">
                                    <div className="kt-widget20">
                                      <div className="kt-widget20__content kt-portlet__space-x">
                                        <span className="kt-widget20__number kt-font-brand">670+</span>
                                        <span className="kt-widget20__desc">Successful transactions</span>
                                      </div>
                                      <div className="kt-widget20__chart" style={{height: '130px'}}>
                                ...
                                <div className="kt-portlet kt-portlet--fit kt-portlet--head-noborder kt-portlet--height-fluid-half">
                                  <div className="kt-portlet__head kt-portlet__space-x">
                                    ...
                                    <div className="kt-portlet__head-toolbar">
                                      <Link to='#' className="btn btn-label-warning btn-sm  btn-bold dropdown-toggle" data-toggle="dropdown">
                                        Download
                                      </Link>
                                      <div className="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                                        <ul className="kt-nav">
                                  ...
                                  <div className="kt-portlet__body kt-portlet__body--fluid">
                                    <div className="kt-widget20">
                                      <div className="kt-widget20__content kt-portlet__space-x">
                                        <span className="kt-widget20__number kt-font-danger">1340+</span>
                                    ...
                                    <div className="kt-timeline-v2">
                                      <div className="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
                                        ...
                                        <div className="kt-timeline-v2__item">
                                          ...
                                          <div className="kt-timeline-v2__item-text kt-timeline-v2__item-text--bold">
                                            AEOL Meeting With
                                          </div>
                                          <div className="kt-list-pics kt-list-pics--sm kt-padding-l-20">
                                            <Link to='#'><img src="../assets/media/users/100_4.jpg"  alt="" /></Link>
                                            <Link to='#'><img src="../assets/media/users/100_13.jpg" alt="" /></Link>
                                            <Link to='#'><img src="../assets/media/users/100_11.jpg" alt="" /></Link>
                                            <Link to='#'><img src="../assets/media/users/100_14.jpg" alt="" /></Link>
                                          </div>
                                        </div>
                                        <div className="kt-timeline-v2__item">
                                          ...
                                          <div className="kt-timeline-v2__item-text kt-padding-top-5">
                                            Make Deposit <Link to='#' className="kt-link kt-link--brand kt-font-bolder">USD 700</Link> To ESL.
                                          </div>
                                        </div>
                                        <div className="kt-timeline-v2__item">
                                        ...
                                        <div className="kt-timeline-v2__item">
                                          ...
                                          <div className="kt-timeline-v2__item-text kt-padding-top-5">
                                            Placed a new order in <Link to='#' className="kt-link kt-link--brand kt-font-bolder">SIGNATURE MOBILE</Link> marketplace.
                                          </div>
                                        </div>
                                        <div className="kt-timeline-v2__item">
                                          <span className="kt-timeline-v2__item-time">16:00</span>
                                        ...
                                        <div className="kt-timeline-v2__item">
                                          ...
                                          <div className="kt-timeline-v2__item-text kt-padding-top-5">
                                            Received a new feedback on <Link to='#' className="kt-link kt-link--brand kt-font-bolder">FinancePro App</Link> product.
                                          </div>
                                        </div>
                                        <div className="kt-timeline-v2__item">
                                          ...
                                          <div className="kt-timeline-v2__item-text kt-padding-top-5">
                                            New notification message has been received on <Link to='#' className="kt-link kt-link--brand kt-font-bolder">LoopFin Pro</Link> product.
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                            ...
                            <div className="row">
                              ...
                              <div className="col-xl-4">
                                ...
                                <div className="kt-portlet kt-portlet--height-fluid kt-widget19">
                                  <div className="kt-portlet__body kt-portlet__body--fit">
                                    <div className="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style={{minHeight: '300px', backgroundImage: 'url(../assets/media//products/product4.jpg)'}}>
                                      <h3 className="kt-widget19__title kt-font-light">
                                        Introducing New Feature
                                      </h3>
                                      <div className="kt-widget19__shadow" />
                                      <div className="kt-widget19__labels">
                                        <Link to='#' className="btn btn-label-light-o2 btn-bold btn-sm ">Recent</Link>
                                      </div>
                                    </div>
                                  </div>
                                  <div className="kt-portlet__body">
                                    <div className="kt-widget19__wrapper">
                                      <div className="kt-widget19__content">
                                        <div className="kt-widget19__userpic">
                                          <img src="../assets/media//users/user1.jpg" alt="user1" />
                                        </div>
                                        <div className="kt-widget19__info">
                                          <Link to='#' className="kt-widget19__username">
                                            Anna Krox
                                          </Link>
                                        ...
                                        <div className="kt-widget19__stats">
                                          ...
                                          <Link to='#' className="kt-widget19__comment">
                                            Comments
                                          </Link>
                                        </div>
                                      </div>
                                    ...
                                    <div className="kt-widget19__action">
                                      <Link to='#' className="btn btn-sm btn-label-brand btn-bold">Read More...</Link>
                                    </div>
                                  </div>
                                </div>
                                {/*end:: Widgets/Blog*/}
                                    ...
                                    <div className="kt-portlet__head-toolbar">
                                      <ul className="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
                                        <li className="nav-item">
                                          <Link className="nav-link active" data-toggle="tab" to="#kt_widget5_tab1_content" role="tab">
                                            Latest
                                          </Link>
                                        </li>
                                        <li className="nav-item">
                                          <Link className="nav-link" data-toggle="tab" to="#kt_widget5_tab2_content" role="tab">
                                            Month
                                          </Link>
                                        </li>
                                        <li className="nav-item">
                                          <Link className="nav-link" data-toggle="tab" to="#kt_widget5_tab3_content" role="tab">
                                            All time
                                          </Link>
                                        </li>
                                      </ul>
                                      ...
                                      <div className="tab-pane active" id="kt_widget5_tab1_content" aria-expanded="true">
                                        <div className="kt-widget5">
                                          <div className="kt-widget5__item">
                                            <div className="kt-widget5__content">
                                              <div className="kt-widget5__pic">
                                                <img className="kt-widget7__img" src="../assets/media//products/product27.jpg" alt="product27" />
                                              </div>
                                          ...
                                          <div className="kt-widget5__item">
                                            <div className="kt-widget5__content">
                                              <div className="kt-widget5__pic">
                                                <img className="kt-widget7__img" src="../assets/media//products/product22.jpg" alt="product22" />
                                              </div>
                                              <div className="kt-widget5__section">
                                                <Link to='#' className="kt-widget5__title">
                                                  Branding Mockup
                                          ...
                                          <div className="kt-widget5__item">
                                            <div className="kt-widget5__content">
                                              <div className="kt-widget5__pic">
                                                <img className="kt-widget7__img" src="../assets/media//products/product15.jpg" alt="product15.jpg" />
                                              </div>
                                              <div className="kt-widget5__section">
                                                <Link to='#' className="kt-widget5__title">
                                                  Awesome Mobile App
                                      ...
                                      <div className="tab-pane" id="kt_widget5_tab2_content">
                                        <div className="kt-widget5">
                                          <div className="kt-widget5__item">
                                            <div className="kt-widget5__content">
                                              <div className="kt-widget5__pic">
                                                <img className="kt-widget7__img" src="../assets/media//products/product10.jpg" alt="product10" />
                                              </div>
                                              <div className="kt-widget5__section">
                                                <Link to='#' className="kt-widget5__title">
                                                  Branding Mockup
                                          ...
                                          <div className="kt-widget5__item">
                                            <div className="kt-widget5__content">
                                              <div className="kt-widget5__pic">
                                                <img className="kt-widget7__img" src="../assets/media//products/product11.jpg" alt="product11.jpg" />
                                              </div>
                                              <div className="kt-widget5__section">
                                                <Link to='#' className="kt-widget5__title">
                                                  Awesome Mobile App
                                          ...
                                          <div className="kt-widget5__item">
                                            <div className="kt-widget5__content">
                                              <div className="kt-widget5__pic">
                                                <img className="kt-widget7__img" src="../assets/media//products/product6.jpg" alt="product6.jpg" />
                                              </div>
                                              <div className="kt-widget5__section">
                                                <Link to='#' className="kt-widget5__title">
                                                  Great Logo Designn
                                      ...
                                      <div className="tab-pane" id="kt_widget5_tab3_content">
                                        <div className="kt-widget5">
                                          ...
                                          <div className="kt-widget5__item">
                                            <div className="kt-widget5__content">
                                              <div className="kt-widget5__pic">
                                                <img className="kt-widget7__img" src="../assets/media//products/product10.jpg" alt="product10.jpg" />
                                              </div>
                                              <div className="kt-widget5__section">
                                                <Link to='#' className="kt-widget5__title">
                                                  Branding Mockup
                                  ...
                                  <div className="kt-portlet__head">
                                    ...
                                    <div className="kt-portlet__head-toolbar">
                                      <ul className="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand" role="tablist">
                                        <li className="nav-item">
                                          <Link className="nav-link active" data-toggle="tab" to={"#kt_widget4_tab1_content"} role="tab">
                                            Today
                                          </Link>
                                        </li>
                                        <li className="nav-item">
                                          <Link className="nav-link" data-toggle="tab" to="#kt_widget4_tab2_content" role="tab">
                                            Month
                                          </Link>
                                        </li>
                                      </ul>
                                    ...
                                    <div className="tab-content">
                                        ...
                                        <div className="kt-widget4">
                                          <div className="kt-widget4__item">
                                            <div className="kt-widget4__pic kt-widget4__pic--pic">
                                              <img src="../assets/media/users/100_4.jpg" alt="100_4.jpg" />
                                            </div>
                                          ...
                                          <div className="kt-widget4__item">
                                            <div className="kt-widget4__pic kt-widget4__pic--pic">
                                              <img src="../assets/media/users/100_14.jpg" alt="100_14.jpg" />
                                            </div>
                                            <div className="kt-widget4__info">
                                              <Link to='#' className="kt-widget4__username">
                                                Milano Esco
                                            ...
                                            <Link to='#' className="btn btn-sm btn-label-warning btn-bold">Follow</Link>
                                          </div>
                                          <div className="kt-widget4__item">
                                            <div className="kt-widget4__pic kt-widget4__pic--pic">
                                              <img src="../assets/media/users/100_11.jpg" alt="100_11.jpg" />
                                            </div>
                                            <div className="kt-widget4__info">
                                              <Link to='#' className="kt-widget4__username">
                                                Nick Bold
                                            ...
                                            <Link to='#' className="btn btn-sm btn-label-danger btn-bold">Follow</Link>
                                          </div>
                                          <div className="kt-widget4__item">
                                            <div className="kt-widget4__pic kt-widget4__pic--pic">
                                              <img src="../assets/media/users/100_1.jpg" alt="100_1.jpg" />
                                            </div>
                                            <div className="kt-widget4__info">
                                              <Link to='#' className="kt-widget4__username">
                                                Wiltor Delton
                                            ...
                                            <Link to='#' className="btn btn-sm btn-label-success btn-bold">Follow</Link>
                                          </div>
                                          <div className="kt-widget4__item">
                                            <div className="kt-widget4__pic kt-widget4__pic--pic">
                                              <img src="../assets/media/users/100_5.jpg" alt="100_5.jpg" />
                                            </div>
                                            <div className="kt-widget4__info">
                                              <Link to='#' className="kt-widget4__username">
                                                Nick Stone
                                            ...
                                            <Link to='#' className="btn btn-sm btn-label-primary btn-bold">Follow</Link>
                                          </div>
                                        </div>
                                      </div>
                                      <div className="tab-pane" id="kt_widget4_tab2_content">
                                        <div className="kt-widget4">
                                          <div className="kt-widget4__item">
                                            <div className="kt-widget4__pic kt-widget4__pic--pic">
                                              <img src="../assets/media/users/100_2.jpg" alt="100_2.jpg" />
                                            </div>
                                            <div className="kt-widget4__info">
                                              <Link to='#' className="kt-widget4__username">
                                                Kristika Bold
                                            ...
                                            <Link to='#' className="btn btn-sm btn-label-success">Follow</Link>
                                          </div>
                                          <div className="kt-widget4__item">
                                            <div className="kt-widget4__pic kt-widget4__pic--pic">
                                              <img src="../assets/media/users/100_13.jpg" alt="100_13.jpg" />
                                            </div>
                                            <div className="kt-widget4__info">
                                              <Link to='#' className="kt-widget4__username">
                                                Ron Silk
                                            ...
                                            <Link to='#' className="btn btn-sm btn-label-brand">Follow</Link>
                                          </div>
                                          <div className="kt-widget4__item">
                                            <div className="kt-widget4__pic kt-widget4__pic--pic">
                                              <img src="../assets/media/users/100_9.jpg" alt="100_9.jpg" />
                                            </div>
                                            <div className="kt-widget4__info">
                                              <Link to='#' className="kt-widget4__username">
                                                Nick Bold
                                            ...
                                            <Link to='#' className="btn btn-sm btn-label-danger">Follow</Link>
                                          </div>
                                          <div className="kt-widget4__item">
                                            <div className="kt-widget4__pic kt-widget4__pic--pic">
                                              <img src="../assets/media/users/100_2.jpg" alt="100_2.jpg" />
                                          ...
                                          <div className="kt-widget4__item">
                                            <div className="kt-widget4__pic kt-widget4__pic--pic">
                                              <img src="../assets/media/users/100_8.jpg" alt="100_8.jpg" />
                                            </div>
                                            <div className="kt-widget4__info">
                                              <Link to='#' className="kt-widget4__username">
                                                Nick Bold
                                            ...
                                            <Link to='#' className="btn btn-sm btn-label-info">Follow</Link>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                  ...
                                  <div className="kt-widget14">
                                    ...
                                    <div className="kt-widget14__content">
                                      <div className="kt-widget14__chart">
                                        ...
                                        <canvas id="kt_chart_profit_share" style={{height: '140px', width: '140px'}} />
                                      </div>
                                ...
                                <div className="kt-portlet kt-portlet--tabs kt-portlet--height-fluid">
                                  <div className="kt-portlet__head">
                                    ...
                                    <div className="kt-portlet__head-toolbar">
                                      <ul className="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand" role="tablist">
                                        <li className="nav-item">
                                          <Link className="nav-link active" data-toggle="tab" to="#kt_widget2_tab1_content" role="tab">
                                            Today
                                          </Link>
                                        </li>
                                        <li className="nav-item">
                                          <Link className="nav-link" data-toggle="tab" to="#kt_widget2_tab2_content" role="tab">
                                            Week
                                          </Link>
                                        </li>
                                        <li className="nav-item">
                                          <Link className="nav-link" data-toggle="tab" to="#kt_widget2_tab3_content" role="tab">
                                            Month
                                          </Link>
                                        </li>
                                      </ul>
                                        ...
                                        <div className="kt-widget2">
                                          <div className="kt-widget2__item kt-widget2__item--primary">
                                            ...
                                            <div className="kt-widget2__info">
                                              <Link to='#' className="kt-widget2__title">
                                                Make Metronic Great Again.Lorem Ipsum Amet
                                              </Link>
                                              <Link to='#' className="kt-widget2__username">
                                                By Bob
                                              </Link>
                                            </div>
                                            <div className="kt-widget2__actions">
                                              <Link to='#' className="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown">
                                                <i className="flaticon-more-1" />
                                              </Link>
                                              <div className="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                                                <ul className="kt-nav">
                                          ...
                                          <div className="kt-widget2__item kt-widget2__item--warning">
                                            <div className="kt-widget2__checkbox">
                                              <label className="kt-checkbox kt-checkbox--solid kt-checkbox--single">
                                                <input type="checkbox" />
                                                <span />
                                          ...
                                          <div className="kt-widget2__item kt-widget2__item--brand">
                                            <div className="kt-widget2__checkbox">
                                              <label className="kt-checkbox kt-checkbox--solid kt-checkbox--single">
                                                <input type="checkbox" />
                                                <span />
                                          ...
                                          <div className="kt-widget2__item kt-widget2__item--success">
                                            <div className="kt-widget2__checkbox">
                                              <label className="kt-checkbox kt-checkbox--solid kt-checkbox--single">
                                                <input type="checkbox" />
                                                <span />
                                          ...
                                          <div className="kt-widget2__item kt-widget2__item--danger">
                                            <div className="kt-widget2__checkbox">
                                              <label className="kt-checkbox kt-checkbox--solid kt-checkbox--single">
                                                <input type="checkbox" />
                                                <span />
                                          ...
                                          <div className="kt-widget2__item kt-widget2__item--info">
                                            <div className="kt-widget2__checkbox">
                                              <label className="kt-checkbox kt-checkbox--solid kt-checkbox--single">
                                                <input type="checkbox" />
                                                <span />
                                            ...
                                            <div className="kt-widget2__info">
                                              <Link to='#' className="kt-widget2__title">
                                                Completa Financial Report For Emirates Airlines
                                                <p />
                                              </Link><Link to='#' className="kt-widget2__username">
                                                By Sean
                                              </Link>
                                            </div>
                                            <div className="kt-widget2__actions">
                                ...
                                <div className="kt-portlet kt-portlet--height-fluid">
                                  <div className="kt-portlet__head">
                                    ...
                                    <div className="kt-portlet__head-toolbar">
                                      <ul className="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
                                        <li className="nav-item">
                                          <Link className="nav-link active" data-toggle="tab" to="#kt_widget6_tab1_content" role="tab">
                                            Latest
                                          </Link>
                                        </li>
                                        <li className="nav-item">
                                          <Link className="nav-link" data-toggle="tab" to="#kt_widget6_tab2_content" role="tab">
                                            Week
                                          </Link>
                                        </li>
                                        <li className="nav-item">
                                          <Link className="nav-link" data-toggle="tab" to="#kt_widget6_tab3_content" role="tab">
                                            Month
                                          </Link>
                                        </li>
                                      </ul>
                                    ...
                                    <div className="tab-content">
                                      ...
                                      <div className="tab-pane" id="kt_widget6_tab2_content" aria-expanded="false">
                                        <div className="kt-notification">
                                          ...
                                          <Link to='#' className="kt-notification__item">
                                            <div className="kt-notification__item-icon">
                                              <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="kt-svg-icon kt-svg-icon--info">
                                                <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                                  ...
                                  <div className="kt-portlet__body">
                                    <div className="kt-widget3">
                                      <div className="kt-widget3__item">
                                        <div className="kt-widget3__header">
                                          <div className="kt-widget3__user-img">
                                            <img className="kt-widget3__img" src="../assets/media/users/user1.jpg" alt="user1.jpg" />
                                          </div>
                                      ...
                                      <div className="kt-widget3__item">
                                        <div className="kt-widget3__header">
                                          <div className="kt-widget3__user-img">
                                            <img className="kt-widget3__img" src="../assets/media/users/user4.jpg" alt="user4.jpg" />
                                          </div>
                                          <div className="kt-widget3__info">
                                            <Link to='#' className="kt-widget3__username">
                                              Lebron King James
                                      ...
                                      <div className="kt-widget3__item">
                                        <div className="kt-widget3__header">
                                          <div className="kt-widget3__user-img">
                                            <img className="kt-widget3__img" src="../assets/media/users/user5.jpg" alt="user5.jpg" />
                                          </div>
                                          <div className="kt-widget3__info">
                                            <Link to='#' className="kt-widget3__username">
                                              Deb Gibson
